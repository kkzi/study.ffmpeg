...
#define FFMPEG_CONFIGURATION                                                                                                                                   \
    "--prefix=/d/Local/vcpkg-latest/packages/ffmpeg_x64-windows/debug --toolchain=msvc --enable-pic --disable-doc --enable-debug --enable-runtime-cpudetect "  \
    "--disable-autodetect --pkg-config='D:/Local/vcpkg-latest/installed/x64-windows/tools/pkgconf/pkgconf.exe' --target-os=win32 --enable-w32threads "         \
    "--enable-d3d11va --enable-dxva2 --enable-mediafoundation --disable-inline-asm --cc=cl.exe --cxx=cl.exe --windres=rc.exe --ld=link.exe --ar='ar-lib "      \
    "lib.exe' --ranlib=':' --enable-gpl --disable-ffmpeg --enable-ffplay --disable-ffprobe --enable-avcodec --enable-avdevice --enable-avformat "              \
    "--enable-avfilter --enable-postproc --enable-swresample --enable-swscale --disable-alsa --disable-amf --disable-libaom --disable-libass "                 \
    "--disable-avisynth --disable-bzlib --disable-libdav1d --disable-libfdk-aac --disable-libfontconfig --disable-libfreetype --disable-libfribidi "           \
    ...
    "--disable-openssl --enable-schannel --disable-libopus --enable-sdl2 --disable-libsnappy --disable-libsoxr --disable-libspeex --disable-libssh "           \
    ...
    "--extra-cflags='-DHAVE_UNISTD_H=0' --debug --disable-optimizations --extra-ldflags='-libpath:D:/Local/vcpkg-latest/installed/x64-windows/debug/lib' "     \
